...
def generate_split_files(data_dir, nb_splits, split_name):
    all_patients = os.listdir(os.path.join(data_dir, 'axial_annotations'))
    ...
    for i in range(nb_splits):
        ...
        with open(os.path.join(data_dir, 'splits_multiview', '{}.{}'.format(split_name, i)), 'w') as f:
...
# python3 generate_split_file.py /local/DEEPLEARNING/DATASETNAME split_1 5 1515465
